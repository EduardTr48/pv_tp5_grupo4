...
const AcercaDe = () => {
    ...
    const integrantes = [
        {
            nombre: "Eduardo Tiago Rodriguez",
            lu: "LU20220202",
        ...
        {
            nombre: "Rodriguez Pablo Alejandro",
            lu: "LU20220204",
        ...
        <Container maxWidth="md" sx={{ py: 4 }}>
            <div className="card">
                ...
                <Box sx={{ mb: 4 }}>
                    ...
                    >
                        Este proyecto fue desarrollado como Trabajo Práctico N°5
                        para la asignatura Programación Visual, perteneciente a
                        la carrera de Analista Programador Universitario en la
                    ...
                    <Typography
                        ...
                        sx={{ color: theme.palette.text.secondary }}
                    >
                        La aplicación permite gestionar una lista de alumnos,
                        con funcionalidades de creación, lectura, actualización
                        y eliminación (CRUD).
                    </Typography>
                </Box>
                ...
                >
                    <Typography variant="body2" color="text.secondary">
                        © 2025 Grupo 4 - Programación Visual - Trabajo Práctico
                        N°5
                    </Typography>
